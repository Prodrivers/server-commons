 ...
 * SQLProvider is intended to be used by a dependency injector, as it uses Prodrivers Commons' internal configuration to
 * spin up connections. SQLProvider is already made available in
 * {@link ProdriversCommonsGuiceModule Prodrivers Commons' public module}: you just have to
